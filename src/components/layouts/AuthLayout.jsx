...
export const AuthLayout = ({ tlwBgColor, children }) => {
    return (
        <div className=" w-[100vw] max-w-full min-h-[90vh] h-auto flex flex-col md:flex-row">
            ...
            <div className='w-full h-auto flex flex-col items-center justify-center gap-5 overflow-x-hidden md:w-1/2'>
                <div className=" w-full flex justify-start mt-2 px-4 md:px-20">
                    <Link 
                        to="/" 
